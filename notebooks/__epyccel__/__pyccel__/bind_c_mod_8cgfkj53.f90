!........................................
function solve_1d_linearconv_pyccel(n0_u, u, n0_un, un, nt, nx, dt, dx, &
      c) bind(c) result(Out_0001)

  use mod_8cgfkj53, only: mod_solve_1d_linearconv_pyccel => &
  ...
  Out_0001 = mod_solve_1d_linearconv_pyccel(u, un, nt, nx, dt, dx, c)
